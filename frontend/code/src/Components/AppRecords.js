                    ...
                    <table className="table table-hover">
                        <thead className="table-dark bg-dark">
                            <tr>
                                ...
                                <th scope="col">URL</th>
                                <th scope="col" className="text-end" style={{ paddingRight: "96px" }}>Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <tr key={record.app_name}>
                                    ...
                                    <td>
                                        {(record.status === "running") ? (
                                            <a href="http://www.google.com" target="_blank">Open App</a>
                                        ) : (
                                            <a>Open App</a>
                                        )}
                                    </td>
                                    <td className="text-end">
                                        ...
                                        {(record.status === "stopped") ? (
                                            ...
                                            <span className="pe-3" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Stop App">
